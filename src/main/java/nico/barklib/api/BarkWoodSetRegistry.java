...
public class BarkWoodSetRegistry {
    ...
    public static void initVanilla() {
        if(vanillaInit) return;

        vanillaInit = true;

        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("oak"))
                        .setPlanks(Blocks.OAK_PLANKS)
                        .setStairs(Blocks.OAK_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("spruce"))
                        .setPlanks(Blocks.SPRUCE_PLANKS)
                        .setStairs(Blocks.SPRUCE_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("birch"))
                        .setPlanks(Blocks.BIRCH_PLANKS)
                        .setStairs(Blocks.BIRCH_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("jungle"))
                        .setPlanks(Blocks.JUNGLE_PLANKS)
                        .setStairs(Blocks.JUNGLE_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("acacia"))
                        .setPlanks(Blocks.ACACIA_PLANKS)
                        .setStairs(Blocks.ACACIA_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("dark_oak"))
                        .setPlanks(Blocks.DARK_OAK_PLANKS)
                        .setStairs(Blocks.DARK_OAK_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("mangrove"))
                        .setPlanks(Blocks.MANGROVE_PLANKS)
                        .setStairs(Blocks.MANGROVE_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("cherry"))
                        .setPlanks(Blocks.CHERRY_PLANKS)
                        .setStairs(Blocks.CHERRY_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("bamboo"))
                        .setPlanks(Blocks.BAMBOO_PLANKS)
                        .setStairs(Blocks.BAMBOO_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("crimson"))
                        .setPlanks(Blocks.CRIMSON_PLANKS)
                        .setStairs(Blocks.CRIMSON_SLAB)
        ...
        registerWoodSet(
                BarkWoodSet.Helper.of(vanillaId("warped"))
                        .setPlanks(Blocks.WARPED_PLANKS)
                        .setStairs(Blocks.WARPED_SLAB)
